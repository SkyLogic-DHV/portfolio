      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-5 bg-white border border-gray-200 rounded-3xl p-6 sm:p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div
              className={`relative rounded-2xl p-6 shadow-xl border ${
                COLOR_CLASSES[selectedColor]?.bg || "bg-yellow-100"
            ...
            >
              ...
              <textarea
                ...
                rows={4}
                className={`w-full bg-transparent resize-none outline-none font-medium text-lg leading-snug placeholder:text-slate-500/70 ${
                  COLOR_CLASSES[selectedColor]?.text || "text-amber-950"
                }`}
              ...
              <div className="mt-4 pt-3 border-t border-black/10 flex items-center justify-between text-xs">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <input
                    ...
                    className={`bg-transparent outline-none font-semibold text-xs border-b border-black/20 focus:border-black/60 w-28 text-right ${
                      COLOR_CLASSES[selectedColor]?.text || "text-amber-950"
                    }`}
                  />
                </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
                ...
                {Object.keys(COLOR_CLASSES).map((colorKey) => (
                  <button
                    ...
                    className={`w-7 h-7 rounded-full border-2 transition-transform ${
                      selectedColor === colorKey ? "scale-125 border-gray-800 shadow-lg" : "border-transparent opacity-80 hover:opacity-100"
                    }`}
                    style={{
                      backgroundColor:
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-3 rounded-full bg-gray-800 hover:bg-gray-700 text-white font-semibold text-xs shadow-lg flex items-center space-x-2 transition-all disabled:opacity-50"
              >
                <span>pin it</span>
